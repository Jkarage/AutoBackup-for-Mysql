...
* The Scripts Creates a Database Backup file  for your *mysql* Database or *mongodb* database.
...
h2. The Variables (Mongodb database)
...
h2. Put this in the .bashrc file in your root directory.
...
MONGO_USERNAME="yourmysqlusername" <br>
export MONGO_USERNAME <br>
export PATH=$PATH:MONGO_USERNAME/bin <br>


MONGO_PASSWD="yourmysqlpassword"
